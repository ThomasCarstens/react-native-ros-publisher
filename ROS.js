  ...
  function getTopics() {
    const topicsPromise = new Promise((resolve, reject) => {
      ros.ROS.getTopics((topics) => {
        ...
        // TOPICS: {"topics": ["/rosout_agg", "/rosout", "/client_count", 
        // "/connected_clients", "/cmd_vel"], 
        // "types": ["rosgraph_msgs/Log", "rosgraph_msgs/Log", 
        // "std_msgs/Int32", "rosbridge_msgs/ConnectedClients", "geometry_msgs/Twist"]}
        ...
        // TOPICS: [{"msgType": "rosgraph_msgs/Log", "path": "/rosout_agg", "type": "topic"}, 
        // {"msgType": "rosgraph_msgs/Log", "path": "/rosout", "type": "topic"}, 
        // {"msgType": "std_msgs/Int32", "path": "/client_count", "type": "topic"}, 
        // {"msgType": "rosbridge_msgs/ConnectedClients", "path": "/connected_clients", "type": "topic"}, 
        // {"msgType": "geometry_msgs/Twist", "path": "/cmd_vel", "type": "topic"}]
